              ...
              <div class="col-md-12">
                <form action="#">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                        <form>
                            ...
                            <textarea class="form-control" id="mensaje"  name="mensaje" rows="3" placeholder="Escriba su mensaje"></textarea>
                          </form>
                    </div>
                  </div>
                  <br>
                  <div class="row">
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                        <p class="description text-white">Tus datos son confidenciales, Donovan Imports no usa estos datos con fines publicitarios ni comparte tu información con terceros. Lee más en nuestro Aviso de Privacidad.</p>
                    </div>
                    </div>
                  </div>
                  <div class="row">
                     <div class="col-md-6">
                        <div class="form-group">
                              ...
                              <div style="width: 304px; height: 78px;">
                                 <div>
                                    <iframe src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LeeJykUAAAAAM3_Nu1SDFP6aRDipraq4I1_-MF6&amp;co=aHR0cHM6Ly9tZXhyZW50YWNhci5jb206NDQz&amp;hl=es-419&amp;v=75nbHAdFrusJCwoMVGTXoHoM&amp;size=normal&amp;cb=c7zs12uu6wnw" role="presentation" name="a-5ebbae2admim" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox allow-storage-access-by-user-activation" width="304" height="78" frameborder="0">
                                    </iframe>
                                 </div>
